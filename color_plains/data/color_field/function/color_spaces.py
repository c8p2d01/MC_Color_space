...
if __name__ == "__main__":
    ...
    generate("render/colors", "hsl", 3, colmath.xyz_to_hsl)
    generate_random("render/colors", "hsl", colmath.xyz_to_hsl, 4)
    generate("render/colors", "lab", 3, colmath.xyz_to_lab)
    generate_random("render/colors", "lab", colmath.xyz_to_lab, 4)
    generate("render/colors", "oklab", 3, colmath.xyz_to_oklab)
    generate_random("render/colors", "oklab", colmath.xyz_to_oklab, 4)
    generate("render/colors", "oklch", 3, colmath.xyz_to_oklch)
    generate_random("render/colors", "oklch", colmath.xyz_to_oklch, 4)